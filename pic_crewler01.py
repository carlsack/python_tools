...
# http请求头
url = "http://www.zhangzishi.cc/20170619mt.html"
...
get_head = soup.find('article', class_='article-content').find_all('p')[0]  #获取标题，来命名文件（现阶段，只相对于没有建立文件夹）
pic_name = get_head.text
pic = soup.find_all('img',class_ ='M_cur_zoom_out' and 'M_cur_zoom_in') #获取图片所在的内容
length = len(pic)   #定义数量
